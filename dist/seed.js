...
var MONGO_URI = process.env.MONGO_URI || "mongodb://admin:secret@localhost:27017";
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, Task_1.default.deleteMany({})];
            case 2:
                // **Clear Existing Data (Optional)**
                _a.sent();
                ...
                // **Insert Data**
                return [4 /*yield*/, Task_1.default.insertMany(tasks)];
            case 3:
                // **Insert Data**
                _a.sent();
