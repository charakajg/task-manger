...
var getTasks = function (queryParams) { return __awaiter(void 0, void 0, void 0, function () {
    var query, priority, completed, _a, page, _b, limit, filter, skip, tasks, total, totalPages;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                query = queryParams.query, priority = queryParams.priority, completed = queryParams.completed, _a = queryParams.page, page = _a === void 0 ? 1 : _a, _b = queryParams.limit, limit = _b === void 0 ? 10 : _b;
                // Sanitize and validate page and limit
                page = Math.max(1, parseInt(page, 10)); // Ensure page is a positive integer, default to 1
                limit = Math.max(1, Math.min(100, parseInt(limit, 10))); // Ensure limit is between 1 and 100
                filter = {};
                if (query) {
            ...
            case 1:
                tasks = _c.sent();
                return [4 /*yield*/, Task_1.default.countDocuments(filter)];
            case 2:
                total = _c.sent();
...
var createTask = function (taskData) { return __awaiter(void 0, void 0, void 0, function () {
    var title, priority, dependencies, recurring, recurringFrequency, taskDependencies, initialSuffixNumber, task, nextRunningDate, recurringSchedule, task;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                taskDependencies = dependencies && dependencies.length > 0
                    ? dependencies
            ...
            case 1:
                task = _a.sent();
                nextRunningDate = (0, moment_1.default)()
                    .add(1, (0, utils_1.mapFrequency)(recurringFrequency))
                    .toDate();
