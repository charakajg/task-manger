...
router.get("/", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, query, priority, recurringSchedules, error_1, errorMessage;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4 /*yield*/, (0, recurringScheduleService_1.getRecurringSchedules)(query, priority)];
            case 2:
...
router.get("/:id", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_2 = _a.sent();
                res.status(400).json({ error: error_2 instanceof Error ? error_2.message : 'Unknown error' });
                return [3 /*break*/, 3];
...
router.put("/:id", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_3 = _a.sent();
                res.status(400).json({ error: error_3 instanceof Error ? error_3.message : 'Unknown error' });
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
...
router.delete("/:id", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_4 = _a.sent();
                res.status(400).json({ error: error_4 instanceof Error ? error_4.message : 'Unknown error' });
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
