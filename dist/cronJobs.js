    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 8, , 9]);
                now = new Date();
                return [4 /*yield*/, RecurringSchedule_1.default.find({
                        nextRunningDate: { $lte: now },
                    })];
            case 2:
                schedules = _a.sent();
            ...
            case 4:
                ...
                newNextRunningDate = (0, moment_1.default)(schedule.nextRunningDate)
                    .add(1, (0, utils_1.mapFrequency)(schedule.frequency))
                    .toDate();
